...
// Logo path for email attachments - White logo for dark email theme
const LOGO_PATH = path.join(__dirname, 'src', 'assets', 'Gemini_Generated_Image_qd4wj2qd4wj2qd4w-removebg-preview.png');
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#050505;">
  <tr>
      ...
      <table width="640" cellpadding="0" cellspacing="0" border="0" style="background-color:#0a0a0a;border:1px solid #1a1a1a;border-top:none;">
        ...
        <tr>
          <td style="background:linear-gradient(180deg,#0d0d0d 0%,#0a0a0a 100%);padding:50px 40px;text-align:center;">
            <img src="cid:logo" alt="XORIAN INDUSTRIES" width="300" style="width:300px;max-width:100%;height:auto;display:block;margin:0 auto;" />
        ...
        <tr>
          <td style="padding:30px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#0d0d0d;border:1px solid #1a1a1a;">
              ...
              ${requirements ? `<!-- Row 4 - Requirements -->
              <tr>
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // CUSTOMER EMAIL - Premium Defense Industry Template
    // ═══════════════════════════════════════════════════════════════════════════
    const userMailOptions = {
      ...
      replyTo: {
        name: 'Xorian Industries',
        address: 'quieres@xorianindustries.com'
      },
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#050505;">
  <tr>
      ...
      <table width="640" cellpadding="0" cellspacing="0" border="0" style="background-color:#0a0a0a;border:1px solid #1a1a1a;border-top:none;">
        ...
        <tr>
          <td style="background:linear-gradient(180deg,#0d0d0d 0%,#0a0a0a 100%);padding:55px 40px;text-align:center;">
            <img src="cid:logo" alt="XORIAN INDUSTRIES" width="320" style="width:320px;max-width:100%;height:auto;display:block;margin:0 auto;" />
    ...
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log(`1️⃣  COMPANY EMAIL (Admin): quieres@xorianindustries.com`);
    console.log(`2️⃣  CUSTOMER EMAIL (User): ${email}`);
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log(`✅ Company Email: ${adminResult.accepted[0]} (MessageID: ${adminResult.messageId})`);
    console.log(`✅ Customer Email: ${userResult.accepted[0]} (MessageID: ${userResult.messageId})`);
    console.log(`📊 Total Emails Delivered: 2`);
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
